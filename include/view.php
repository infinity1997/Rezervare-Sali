...
<div class="container">       
 <button style="width: 48%;length:30px; margin-left: 1%;" id="buton1" name="buton1" type="submit">Cursuri/alte activități</button>
 <button style="width: 48%;length:30px; margin-left: 1%;" id="buton2" name="buton2" type="submit">Laboratoare</button>
    <div class="row">
