...
!function (a) {
    ...
    function Na(c) {
        ...
        function f(b, c) {
            g(b, function (d) {
                var e, f, g, h = a.isArray(b.rezervari);
                if (c == R) {
        ...
        function i(b) {
            ...
            if (a.isFunction(b) || a.isArray(b) ? c = {rezervari: b} : "string" == typeof b ? c = {url: b} : "object" == typeof b && (c = a.extend({}, b)), c) {
                for (c.className ? "string" == typeof c.className && (c.className = c.className.split(/\s+/)) : c.className = [], a.isArray(c.rezervari) && (c.origArray = c.rezervari, c.rezervari = a.map(c.rezervari, function (a) {
                    return s(a, c)
        ...
        function l(a) {
            return ("object" == typeof a ? a.origArray || a.googleCalendarId || a.url || a.rezervari : null) || a
        }
        ...
        function p(a, b) {
            var c, d, e, f = s(a);
            if (f) {
                for (c = w(f), d = 0; d < c.length; d++) e = c[d], e.source || (b && (O.rezervari.push(e), e.source = O), T.push(e));
                return N(T), c
            }
            return []
        }
        ...
        function q(b) {
            ...
            for (null == b ? b = function () {
                ...
                return a._id == c
            }), T = a.grep(T, b, !0), d = 0; d < Q.length; d++) a.isArray(Q[d].rezervari) && (Q[d].rezervari = a.grep(Q[d].rezervari, b, !0));
            N(T)
        }
        ...
        var L, M, N = K.reportEvents, O = {rezervari: []}, Q = [O], R = 0, S = 0, T = [];
        a.each((c.rezervari ? [c.rezervari] : []).concat(c.eventSources || []), function (a, b) {
            var c = i(b);
            c && Q.push(c)
