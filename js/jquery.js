...
!function (a, b) {
    ...
    m.event = {
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r) {
                c.handler && (i = c, c = i.handler, e = i.selector), c.guid || (c.guid = m.guid++), (g = r.rezervari) || (g = r.rezervari = {}), (k = r.handle) || (k = r.handle = function (a) {
        ...
        remove: function (a, b, c, d, e) {
            ...
            if (r && (k = r.rezervari)) {
                ...
                m.isEmptyObject(k) && (delete r.handle, m._removeData(a, "rezervari"))
            }
        },
        trigger: function (b, c, d, e) {
            ...
            if (h = l = d = d || y, 3 !== d.nodeType && 8 !== d.nodeType && !$.test(p + m.event.triggered) && (p.indexOf(".") >= 0 && (q = p.split("."), p = q.shift(), q.sort()), g = p.indexOf(":") < 0 && "on" + p, b = b[m.expando] ? b : new m.Event(p, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = q.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : m.makeArray(c, [b]), k = m.event.special[p] || {}, e || !k.trigger || k.trigger.apply(d, c) !== !1)) {
                ...
                n = 0;
                while ((h = o[n++]) && !b.isPropagationStopped()) b.type = n > 1 ? i : k.bindType || p, f = (m._data(h, "rezervari") || {})[b.type] && m._data(h, "handle"), f && f.apply(h, c), f = g && h[g], f && f.apply && m.acceptData(h) && (b.result = f.apply(h, c), b.result === !1 && b.preventDefault());
        ...
        dispatch: function (a) {
            a = m.event.fix(a);
            var b, c, e, f, g, h = [], i = d.call(arguments), j = (m._data(this, "rezervari") || {})[a.type] || [],
    ...
    function Ab(a, b) {
        if (1 === b.nodeType && m.hasData(a)) {
            var c, d, e, f = m._data(a), g = m._data(b, f), h = f.rezervari;
            if (h) {
                delete g.handle, g.rezervari = {};
    ...
    function Bb(a, b) {
        ...
        if (1 === b.nodeType) {
            if (c = b.nodeName.toLowerCase(), !k.noCloneEvent && b[m.expando]) {
                e = m._data(b);
                for (d in e.rezervari) m.removeEvent(b, d, e.handle);
    ...
    m.extend({
        clone: function (a, b, c) {
            ...
            for (var d, e, f, g, h = 0, i = m.expando, j = m.cache, l = k.deleteExpando, n = m.event.special; null != (d = a[h]); h++) if ((b || m.acceptData(d)) && (f = d[i], g = f && j[f])) {
                if (g.rezervari) for (e in g.rezervari) n[e] ? m.event.remove(d, e) : m.removeEvent(d, e, g.handle);
